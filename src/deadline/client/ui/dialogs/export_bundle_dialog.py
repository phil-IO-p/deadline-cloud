...
class ExportBundleDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self.setWindowTitle(tr("Export bundle"))
    ...
    def _build_ui(self, default_name: str):
        ...
        source_row.addWidget(QLabel("Save to:"))
        ...
        self._export_button = QPushButton(tr("Export bundle"))
    ...
    def _on_browse(self):
        directory = QFileDialog.getExistingDirectory(
            self, "Select export directory", self._location_edit.text()
        )
        if directory:
